      ...
      <div class="col-md-6 item-box">
        ...
        <div class="card mb-4 item-detail-card">
          ...
          <div class="report-btn-container text-center">
            ...
            <button class="report-missing-btn" id="foundbtn">Found</button>
          </div>
        </div>
      </div>
    </div>
...
$(document).ready(function(){
    $('#foundbtn').click(function(){
      var itemId = <?php echo $itemId; ?>;
        $.ajax({
            url: 'mark_as_found.php', // URL of your PHP script
            method: 'POST',
            data: { item_id: itemId }, // Replace 'your_item_id_here' with the actual item ID
            success: function(response){
                // Handle the response from the PHP script
                console.log(response);
                // Reload the page or update the UI as needed
                location.reload(); // Example: Reload the page after marking item as found
            },
